...
/**
 * The Object Action Delegate for externalizable.
 * 
 * @author Adarsh
 * 
 * @version 1.0, 2005
 ...
 */
public class ExternalizableGeneratorOAD implements IObjectActionDelegate {
	/**
		...
		for (int i = 0; i < compUnits.length; i++) {
			...
			try {
				if (type != null && type.isClass()) {
					SourceManipulator.createExternalizableWithJavaDoc(type);
				} else {
					failed++;
				}
				...
				Logger.error("Error generating externalizable " + "through OAD", e);
