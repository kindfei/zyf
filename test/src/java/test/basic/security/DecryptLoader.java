...
public class DecryptLoader extends ClassLoader {

	private Cipher cipher;

	public DecryptLoader(byte[] rawKey) throws GeneralSecurityException, IOException {
	...
	public static void main(String args[]) throws Exception {
		...
		byte[] rawKey = {};
		DecryptLoader dr = new DecryptLoader(rawKey);
