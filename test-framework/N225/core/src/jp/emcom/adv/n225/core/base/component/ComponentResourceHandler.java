...
public class ComponentResourceHandler {
	...
	public boolean equals(Object obj) {
		if (obj instanceof ComponentResourceHandler) {
			...
			if (this.loaderName.equals(other.loaderName) && this.componentName.equals(other.componentName)
	...
	public String toString() {
		return "ComponentResourceHandler from XML file [" + this.componentName + "] with loaderName [" + loaderName
